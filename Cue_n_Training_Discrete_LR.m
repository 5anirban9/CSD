function [sys,x0,str,ts,simStateCompliance] = Cue_n_Training_Discrete_LR(t,x,u,flag,Planning,classLabels)
...
switch flag,
  ...
  case 3
    sys=mdlOutputs(t,x,u,Planning,classLabels);
...
global ready prepLeft prepRight RightNow blank LeftNow fdStart  imStatus   trlNum 
...
fdStart=rgb2gray(imread('Images\TrainingStart.jpg'));
trlNum=0;
...
%=============================================================================
%
function sys = mdlOutputs(t,x,u,Planning,classLabels) 
global ready prepLeft prepRight RightNow blank LeftNow fdStart     imStatus      trlNum 
