function [sys,x0,str,ts,simStateCompliance] = f_S_Classify_UKRI(t,x,u,flag,TR_MDL)
...
%=============================================================================
%
function sys = mdlOutputs(t,x,u,TR_MDL)
...
elseif(u(1:6,:)==[1;1;1;1;1;1])
    ...
    label=svmclassify(TR_MDL.svm_mdls,u([1,3,4,6])');
    if(label==1)
    sys=4;
