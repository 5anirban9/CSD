function [sys,x0,str,ts,simStateCompliance] = sbpf_uC3CzC4(t,x,u,flag)
...
Signal_in_cz_u(i)=u(2);
Signal_in_c4_u(i)=u(3);
if(i==2000)        
    ...
    Signal_out_c3 = filter(B_u,A_u,Signal_in_c3_u);  
    ...
    BP_Signal_cz=Signal_out_cz;
    BP_Signal_c4=Signal_out_c4;
fbp_c3_u(f,:) = BP_Signal_c3;  
fbp_cz_u(f,:) = BP_Signal_cz;  
