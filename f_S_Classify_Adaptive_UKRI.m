function [sys,x0,str,ts,simStateCompliance] = f_S_Classify_Adaptive_UKRI(t,x,u,flag,TR_MDL,COEFF,z_last,x_last,sigma_error_2,lambda,L,LCL_ini,UCL_ini,ERD_Mean,Train_X,Train_Y,classLabelsOrg,Time_Win)
