...
src_path='C:\Users\P1034\Desktop\UKIERI_PaperRelatedDocs\InputData\';
src_path2='C:\Users\P1034\Desktop\UKV3_Documents from IITK\Writing Phase\Paper2\ResultFactory\OutputResult';

addpath(genpath('E:\Writing Phase\Paper2\ResultFactory\functions_UU_March2016\'));

for subID=1:length(SubjectNameList)
...
% save([src_path2 'TrainingAnalysisReport' num2str(Planning) num2str(Propreoception) SubjectName '.mat'],'chList','TR_MDL_TimeLine','meanTrainingCrossValidationAcc_TimeLine','Genacc_TimeLine',...
